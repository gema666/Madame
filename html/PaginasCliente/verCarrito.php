...
$query="SELECT articulo.IdArticulo, carro.Talla, carro.IdUsuario , articulo.Nombre, articulo.Precio, articulo.Oferta, articulo.Stock, carro.CantidadProducto, carro.PrecioSuma FROM carro_articulo INNER JOIN articulo ON 
articulo.IdArticulo=carro_articulo.IdArticulo INNER JOIN carro ON carro_articulo.IdCarro=carro.IdCarro WHERE carro.IdUsuario='$IdUsuario'";	
...
<div class="super_container">
  ...
  <div class="checkout">
    <div class="container">
      <div class="row">
        ...
        <div class="billing">
        <div class="checkout_title">CARRITO</div>
          
        <div class="product_name">


			<form  name ="Modificar" method="POST" action="Direccion.php">
  ...
  <table>
          <tr>
            ...
            <th>Descuento (%)</th>
            <th>Cantidad</th>  
             <th>Total <br>(Con % incluido)<br></th> 
          ...
          <tr>
            <td><input type="text"  id="Nombre" name="Nombre" value="<?php echo $fila['Nombre']; ?> "  readonly></td>
            <td><input type="text"  id="Precio" name="Precio" value="<?php echo $fila['Precio']; ?>" readonly> </td>
            <td><input type="text"  id="Oferta" name="Oferta" value="<?php echo $fila['Oferta']; ?>" readonly></td>
            <td><input readonly type="number" min="1" min="1"  id="Cantidad" name="Cantidad" value="<?php echo $fila['CantidadProducto']; ?>">
          	<input type="hidden"  id="Talla" name="Talla" value="<?php echo $fila['Talla']; ?>" readonly> 
			     <td><input type="text"  id="PrecioSuma" name="PrecioSuma" value="<?php echo $fila['PrecioSuma'];?>" readonly></td>
           <?php
           $Pagar=$Pagar+$fila['PrecioSuma'];
           ?>
          ...
          <H3><STRONG>TOTAL A PAGAR $<input type="text"  id="Pagar" name="Pagar" value="<?php echo $Pagar;?>" readonly></STRONG><H3>
		<input class="cart_total_button" type="submit" value="COMPRAR" name="B1">
       </Form></div>
