...
<div class="super_container">
            ...
            <div class="home_content">
              ...
              <div class="breadcrumbs">
                <ul>
                  ...
                  <li><a href="ComprobanteCompra.php">Comprobante</a></li>
  ...
  <div class="checkout">
    <div class="container">
      <div class="row">
        ...
        <div class="col-lg-6">
        <div class="billing">
        <div class="checkout_title">COMPRA REALIZADA</div> 
        ...
        <!-- <label> Usuario <?php echo $varsesion; ?><br><br>-->
           ...
           <H4><STRONG>CLAVE UNICA DE COMPRA<input type="text"  id="id" name="id" value="<?php echo $ultimoid_compra;?>" readonly></STRONG></H4>
  ...
  <table>
          ...
          <tr>
            ...
            <td><input type="text"  id="Precio" name="Precio" value="<?php echo $fila['CantidadProducto']; ?>" readonly> </td>
...
<?php
 		...
 		{
 			echo '<script>alert ("No  hay compras ");</script>';
