						...
						<div class="home_content">
							...
							<div class="breadcrumbs">
								<ul>
									...
									<li><a href="Nuevos.php">ArticulosNuevos</a></li>
	...
	<div class="checkout">
		<div class="container">
			<div class="row">
				...
				<div class="billing">
				<div class="checkout_title">PRODUCTOS NUEVOS</div>
...
WHERE FechaRegistro  = (
   SELECT MAX(FechaRegistro) as ultimoRegistroarticulo FROM articulo
)";	
...
?>
	<tr>
		...
		<td colspan="3"><?php echo $fila['Precio'];?>$<br>
				<?php echo $fila['Oferta'];?>% de descuento<br>
			</td>
		<td colspan="3"><a href="VerArticulo.php ?IdArticulo=<?php echo $fila['IdArticulo']; ?>"><h1>ver<h1></a>
